			...
			<div class="single-main">
               ...
               <?php
						...
						if(isset($_GET['id_item'])){
							...
							$id_item_single=$_GET['id_item'];
                
                        $get_item="select * from items WHERE id=$id_item_single";
                        
                        $run_item=mysqli_query($con, $get_item);
                        
                        while ($row_item=mysqli_fetch_array($run_item)){
                            $id_item=$row_item['id'];
							$nom_item=$row_item['nom_item'];
							$prix_item=$row_item['prix'];
							$details_item=$row_item['Details'];
				...
				<div class="sngl-top"> 
					...
					<div class="col-md-7 single-top-right">
						...
						<h2><?php echo $nom_item  ;?></h2>
							...
							<h5 class="item_price">$ <?php echo $prix_item  ;?></h5>
							<p><?php echo $details_item  ;?></p>
							<div class="available">
								<ul>
									<li>Color
										<select>
